...
export const placesData: IPlacesData[] = [
  {
  ...
  {
    img: 'assets/images/2/n21.png',
    address: 'do you know de wey',
    phone: 484372221403,
    weather: {
      title: 'sun',
      icon: 'assets/images/sun.svg',
...
export const placesData$: Observable<IPlacesData[]> = of(placesData)
  .pipe(
    delay(500)
  );
